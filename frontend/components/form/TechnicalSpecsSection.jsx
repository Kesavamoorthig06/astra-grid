...
export default function TechnicalSpecsSection({ formData, handleChange }) {
  return (
    <FormSection icon={GiElectric} title="Technical Specifications" iconClassName="text-green-400">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
        <div>
          <label className="block text-sm font-medium mb-1.5">Voltage Level (kV)</label>
          <Select
          ...
          >
            ...
            <SelectContent className="z-50">
              <SelectItem value="400">400 kV</SelectItem>
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5">Line Length (km)</label>
          <input
            type="number"
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5">Number of Bays</label>
          <input
            type="number"
