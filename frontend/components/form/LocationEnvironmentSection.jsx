...
export default function LocationEnvironmentSection({ formData, handleChange }) {
  return (
    <FormSection icon={TbWorldLatitude} title="Location & Environment" iconClassName="text-green-400">
      <div className="space-y-3">
        <div>
          <label className="block text-sm font-medium mb-1.5">
            Terrain Complexity: {formData.terrain_complexity_index}/10
          </label>
        ...
        <div>
          <label className="block text-sm font-medium mb-1.5">
            Environmental Impact Severity: {formData.environmental_impact_severity}/5
          </label>
          <div className="flex items-center h-9">
            <Slider
              min={1}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
            <label className="block text-sm font-medium mb-1.5">Forest Land Required (ha)</label>
            <input
              type="number"
          ...
          <div>
            <label className="block text-sm font-medium mb-1.5">Annual Rainfall (mm)</label>
            <input
              type="number"
